# DAT505-CODE
This code creates the camera scene, and then, with the sequence code, the number of models generated in the scene is no more than 500. I import a mirror-like model I am looking for, define its size, make its location random, and start rotating them together.
```javascript
var container, stats;
