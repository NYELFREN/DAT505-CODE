# DAT505-CODE
This code defines the basic camera scene and renderer, and I created a geometry that gives it color and location and size to display on the screen.
```javascript
//Global variables
...
function init(){
  ...
  scene.add( mesh );
```
This code is to create a GUI controller, which can control the size, position and angle of the object, and finally define the motion mode of the object.
