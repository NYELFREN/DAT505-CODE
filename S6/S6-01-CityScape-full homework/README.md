# DAT505-CODE
This code creates the camera scene renderer, which USES a first-person perspective and can be changed with a mouse click.
```javascript
// GLOBALS ======================================================
...
```
This code first created a plane, and then used the random code to generate buildings simulated by cuboids randomly in the scene. Then I made the presentation mode of these buildings linear to practice.
```javascript
function setupWorld() {
  //Create the geometry for the floor
  var geo = new THREE.PlaneGeometry(2000, 2000, 40, 40);
  var mat = new THREE.MeshPhongMaterial({color: 0x000000, overdraw: true});
  ...
  var material = new THREE.MeshPhongMaterial({overdraw: true, color: 0xcccccc,wireframe:true});
